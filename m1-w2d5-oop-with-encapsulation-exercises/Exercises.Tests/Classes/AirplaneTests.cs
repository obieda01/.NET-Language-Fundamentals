...
namespace Exercises.Tests.Classes
{
    ...
    public class AirplaneTests
    {
        ...
        public void Airplane_ReserveSeatsTest()
        {
            ...
            MethodInfo method = type.GetMethod("ReserveSeats");
            Assert.AreEqual(true, method.Invoke(airplane, new object[] { true, 1 }), "Reserve should return true if a seat can be booked."); //first class seat
            Assert.AreEqual(true, method.Invoke(airplane, new object[] { false, 2 }), "Reserve should return true if a seat can be booked."); //first class seat
