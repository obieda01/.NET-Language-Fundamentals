...
namespace TechElevator.Classes.Tests
{
    ...
    public class CalculatorTests
    {
        ...
        public void Calculator_RequiredMembers()
        {
            ...
            FieldInfo fi = type.GetField("result");
            Assert.IsNotNull(fi, "Calculator needs a result variable.");
            Assert.AreEqual(typeof(int), fi.FieldType, "result should be type: int");
        ...
        public void Calculator_ResetTest()
        {
            ...
            type.GetField("result").SetValue(calculator, 10);
            type.GetMethod("Reset").Invoke(calculator, null);

            Assert.AreEqual(0, type.GetField("result").GetValue(calculator), "Reset() should set result to 0");
        }
        ...
        public void Calculator_AddTest()
        {
            ...
            Assert.AreEqual(20, type.GetField("result").GetValue(calculator), "Add() should update the value for result by adding addend.");
        }
        ...
        public void Calculator_MultipleTest()
        {
            ...
            Assert.AreEqual(40, type.GetField("result").GetValue(calculator), "Multiply() should update the value for result by multiplying by multiplier.");
        }
        ...
        public void Calculator_SubtractTest()
        {
            ...
            Assert.AreEqual(6, type.GetField("result").GetValue(calculator), "Subtract() should update the value for result by subtracting by subtrahend.");
        }
        ...
        public void Calculator_PowerTest()
        {
            ...
            type.GetField("result").SetValue(calculator, 5);
            Assert.AreEqual(25, mi.Invoke(calculator, new object[] { 2 }), "Power() should return the new value for result.");
            Assert.AreEqual(25, type.GetField("result").GetValue(calculator), "Power() should update the value for raising result to the exponent.");
        }
